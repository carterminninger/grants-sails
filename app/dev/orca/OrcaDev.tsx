...
/* Dev-only orca test bench. Four ratified poses × six sizes of the ONE
   profile (tail ruled 2026-08-31: the broad two-lobed fan — no options
   remain). All poses are in-plane transforms, exactly as the scene
   applies them.

   Sizes: 600 and 200 px reference, then the ACTUAL in-scene lengths
   (2.2 × oL: desktop 1440×844 → 108 px, mobile 390 → 29 px) and the
   ×1.35 candidates ruled for Step-4 integration.                        */
  ...
  return (
    <main style={{ background: BG, minHeight: "100vh", padding: "24px", fontFamily: "monospace", color: "#eaf4f9" }}>
      ...
      <p style={{ fontSize: "12px", opacity: 0.8, marginBottom: "20px" }}>
        one profile, one tail (D, ruled 2026-08-31) · rows = poses · columns = sizes
      </p>
      {POSES.map(pose => (
